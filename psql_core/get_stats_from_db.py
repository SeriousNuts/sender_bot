...
class Stats:
    ...
    def stats(self, sended_message_count, forbidden_message_count, bad_request_message_count,
              flood_wait_message_count, not_sended_message_count, not_found_message_count, delayed_message_count):
        ...
        self.delayed_message_count = delayed_message_count
    ...
    def get_stats_from_row(self, row):
        ...
        self.delayed_message_count = row[6]
...
async def get_full_stats_by_schedule_owner_id(schedule_owner_id):
    result = session.query(
        ...
        func.count().filter(Message.status == 6).label('delayed_message_count')
